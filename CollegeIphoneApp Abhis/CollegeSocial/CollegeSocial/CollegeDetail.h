...
- (/*type goes here but I'm not sure what type to put, will determine it later*/) formatCollegeDataForDisplay; // Arranges the data brought by the fetch into a neat visual layout for the GUI
